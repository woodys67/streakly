...
- [ ] **[P1-1]** `flutter_local_notifications` 추가 및 알림 서비스 구현
- [ ] **[P1-1]** 챌린지 생성 시 알림 자동 등록
- [ ] **[P1-1]** 챌린지 삭제 시 알림 취소
- [ ] **[P1-1]** 알림 설정 토글 실제 연동
- [ ] **[P1-2]** 완료 챌린지 카드에 `onTap` 추가
- [ ] **[P1-2]** 완료 챌린지 상세 화면 구현 또는 기존 화면 재활용
- [ ] **[P1-3]** `settings_screen.dart` 하드코딩 5개 항목 다국어 처리
- [ ] **[P1-3]** `auth_provider.dart` 에러 메시지 다국어 처리
- [ ] **[P1-4]** `AppTheme.darkTheme` 정의
- [ ] **[P1-4]** `app.dart`에 `darkTheme` + `themeMode` 적용

### 출시 전 권장

- [ ] **[P2-1]** `getBadgesEarned()` 임시 로직 정리
- [ ] **[P2-2]** Supabase 에러 원문 노출 차단 및 다국어 에러 메시지 처리
