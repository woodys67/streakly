class AppStrings {
  ...
  String get recoverStreakConfirmBody => _s(en:'Watch a short ad to recover yesterday\'s streak.', ko:'짧은 광고를 시청하면 어제의 스트릭을 복구할 수 있습니다.', ja:'短い広告を見ると昨日のストリークを回復できます。', zhCN:'观看短广告即可恢复昨天的连续记录。', zhTW:'觀看短廣告即可恢復昨天的連續記錄。', es:'Mira un anuncio corto para recuperar la racha de ayer.', de:'Schau eine kurze Werbung, um den gestrigen Streak zurückzubekommen.', pt:'Assista a um anúncio curto para recuperar a sequência de ontem.', ru:'Посмотрите короткую рекламу, чтобы восстановить вчерашнюю серию.');
  String get adNotReady => _s(en:'Ad not ready. Please try again shortly.', ko:'광고를 불러오는 중입니다. 잠시 후 다시 시도해주세요.', ja:'広告を読み込んでいます。少し後にお試しください。', zhCN:'广告加载中，请稍后再试。', zhTW:'廣告載入中，請稍後再試。', es:'Anuncio no listo. Inténtalo de nuevo en breve.', de:'Werbung wird geladen. Bitte versuche es gleich erneut.', pt:'Anúncio não pronto. Tente novamente em breve.', ru:'Реклама загружается. Попробуйте снова через мгновение.');
